...
def detect(source, lvl_2, lvl_3):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            #print(lvl_2, lvl_3)
            if currentH > float(lvl_3) * thr_h and float(conf) >= 0.5 and height_diff > 10:
            ...
            elif (currentH > float(lvl_2) * thr_h and currentH <= float(lvl_3) * thr_h and float(conf) >= 0.5) or (
                    currentH > float(lvl_2) * thr_h and height_diff <= 10 and float(
...
def index(request):
    ...
    if request.method == 'POST':
        lvl_2 = request.POST.get("lvl_2")
        lvl_3 = request.POST.get("lvl_3")
        source = '0'
        return StreamingHttpResponse(detect(source, lvl_2, lvl_3),
...
# eel.start('examples/hello2')
    # else:
    #     print('no save')
    #
    # return render(request, 'pak')